                        ...
                        >
                            <Card className="mx-0 lg:col-span-3 lg:mr-0 relative p-6">
                                <CardContent className="max-w-full prose dark:prose-invert  p-0 pt-2">
                                    For this website I used a stack comprising
                                    Typescript, ReactJs, NextJs, CSS modules,
                                    Tailwind, Prisma, and CI/CD with Vercel. The
                                    homepage, designed with CSS modules, employs
                                    a best practice to isolate styles
                                    effectively and Iused some shadcn components
                ...
                <div className="relative">
                    <div className="relative prose dark:prose-invert w-full max-w-full grid grid-cols-1 sm:grid-cols-2  gap-4 m-auto ">
                        <Card className="cards-portfolio techs m-auto w-full">
                            ...
                            <CardFooter>
                                This project I developed while undertaking a
                                Next.js course is a system that serves as a
                                Ticket Services platform, enabling the creation
                                of tickets or tasks related to ongoing project
                                activities. A user can create, edit, delete, and
                                mark as completed a ticket.
                            </CardFooter>
                        ...
                        <Card className="cards-portfolio techs m-auto w-full">
                            <CardHeader className="cards-portfolio-header">
                                ...
                                <CardDescription className="portfolio-card-description text-sm">
                                    ...
                                    importance of creating a design system to
                                    maintain consistency in design and
                                    development.
                                </CardDescription>
                            </CardHeader>
                            <Image
                            ...
                            />
                            <CardFooter>
                                In this project, I developed a simple design
                                system using Storybook to demonstrates the
                                creation of components and their documentation.
                                The ControlContainer component is a flex
                                container that wraps its children and allows the
                                user to set the layout direction, margins,
                                paddings, and much more. This project is
                                published on Chromatic and npm.
                                <br></br>
                            ...
                            <CardFooter>
                                ...
                                >
                                    ...
                                    <br />
                                    <br />
                                    &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&lt;Chat
                                    /&gt;
                                    <br />
                                    &emsp;&emsp;&emsp;&emsp;&emsp;&lt;/Box&gt;
                                    <br />
                            ...
                            <Link
                                ...
                                key="Tickets App"
                            >
                                Go to an example of usage of the Storybook
                            </Link>
                        </Card>
                    </div>
                    <div className="box">
